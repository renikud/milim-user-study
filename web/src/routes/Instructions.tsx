              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div className="flex-1 space-y-2 text-slate-800">
                  <p className="text-sm sm:text-base leading-relaxed">
                    יוצג בפניך משפט, ובתוכו מילה אחת מודגשת. שתי ההקלטות שתשמע.י הן של המילה המודגשת בלבד,
                    בשתי גרסאות הגייה שונות. תתבקש.י להשוות בין שתי ההקלטות ולהעריך איזו מהן נשמעת יותר כמו עברית מדוברת יומיומית.
                  </p>
                  ...
                  <div className="space-y-2 pr-2 sm:pr-4">
                    <div className="space-y-1">
                      ...
                      <p className="pr-3 sm:pr-6 text-sm sm:text-base leading-relaxed">
                        בחרו את ההקלטה של המילה המודגשת שנשמעת יותר כמו אדם שמדבר עברית רגילה ביום-יום.
                      </p>
                    </div>
